// ======================================================================
// \title  FprimeSoakTestReferenceDeploymentTopologyDefs.hpp
// \brief required header file containing the required definitions for the topology autocoder
//
// ======================================================================
#ifndef FPRIMESOAKTESTREFERENCEDEPLOYMENT_FPRIMESOAKTESTREFERENCEDEPLOYMENTTOPOLOGYDEFS_HPP
#define FPRIMESOAKTESTREFERENCEDEPLOYMENT_FPRIMESOAKTESTREFERENCEDEPLOYMENTTOPOLOGYDEFS_HPP
 ...
 *
 * The topology autocoder requires an object that carries state with the name `FprimeSoakTestReference::TopologyState`. Only the type
