// ======================================================================
// \title  FprimeSoakTestReferenceDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef FPRIMESOAKTESTREFERENCEDEPLOYMENT_FPRIMESOAKTESTREFERENCEDEPLOYMENTTOPOLOGY_HPP
#define FPRIMESOAKTESTREFERENCEDEPLOYMENT_FPRIMESOAKTESTREFERENCEDEPLOYMENTTOPOLOGY_HPP
// Included for access to FprimeSoakTestReferenceDeployment::TopologyState and FprimeSoakTestReferenceDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <FprimeSoakTestReference/FprimeSoakTestReferenceDeployment/Top/FprimeSoakTestReferenceDeploymentTopologyDefs.hpp>
 ...
 * FprimeSoakTestReferenceDeployment::TopologyState see: FprimeSoakTestReferenceDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type FprimeSoakTestReference::TopologyState see: FprimeSoakTestReferenceTopologyDefs.hpp.
 *
